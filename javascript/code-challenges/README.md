...
The daily challenges will be posted by the instructor at the end of lecture every day. Plan to focus on this task with your partner every day after class until 6 p.m., completing as much as possible during this time, then complete the remainder of the challenges on your own, as neeed.
...
- Run your test from the root of the `data-structures-and-algorithms` repository, as follows
  ...
  - Run a specific test: `npm test challenges-01 ` // tesssst test test test test
