...
const addTwo = (arr) => {
  let newArray = arr.map((elmnt)=> elmnt + 2)
  return newArray;
};
...
const typeNum = (arr) => {
  ...
  let newArray = arr.filter((elmnt) => typeof elmnt === 'number')
  return newArray;
};
...
const containsAnd = (arr) => {
  const string ="and";
  let newArray = arr.filter((elmnt) => elmnt.includes(string) )
...
const oddValues = (arr) => {
  ...
  let newArray = arr.filter((elmnt) => elmnt % 2 )
...
const notInFirstArray = (forbiddenValues, arr) => {
  let newArray = forbiddenValues.filter((elmnt) => !(arr.includes(elmnt)))
  .concat(arr.filter((elmnt) => !(forbiddenValues.includes(elmnt))));
  return newArray
};
